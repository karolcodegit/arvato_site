...
function createRectangle(doc, x, y, width, height, options = {}, rows = []) {
    ...
    rows.forEach((row) => {
      ...
      doc.text(row.text, x + row.x, y + row.y, { align: row.align, maxWidth: width - 10 });
    });
...
export const generatePdf = (data) => {
    ...
    createRectangle(doc, 10, 10, 95, 30, {}, [
        { text: '1. Nadawca (nazwisko lub nazwa, adres, kraj)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 2, y: 4 },
        { text: 'Sender (name, address, coutry)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        { text: 'Nazwa firmy', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 15 },
        { text: 'Nazwa', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 20 },
        { text: 'adres', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 25 },
      ]);
      ...
      createRectangle(doc, 10, 40, 95, 20, {}, [
        { text: '2. Obiorca (nazwisko lub nazwa, adres, kraj)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 2, y: 4 },
        { text: 'Consignee (name, address, country)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        { text: 'Nazwa firmy (odbiorca)', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 15 },
      ]);
      //3
      createRectangle(doc, 10, 60, 95, 17, {}, [
        { text: '3. Miejsce przeznaczenia (miejscowosc, kraj)', font: 'helvetica', fontSize: 5, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Place of delivery of the goods (place, country)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        { text: 'Nazwa firmy (odbiorca)', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 15 },
      ]);
      //4
      ...
      createRectangle(doc, 105, 60, 95, 17, {}, [
        { text: '17. Kolejni przewoznicy (nazwisko lub nazwa, adres, kraj)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 2, y: 4 },
        { text: 'Successive carriers (name, address, country)', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        { text: '', font: 'helvetica', fontSize: 10, align: 'center', bold: true, x: 95/2, y: 15 },
      ]);
      //18
      createRectangle(doc, 105, 77, 95, 35, {}, [
        { text: '18. Zastrzezenia i uwagi przewoznika', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 2, y: 4 },
        { text: 'Carrier\'s reservations and observations', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 7 },
        
      ]);

      //6-9
      createRectangle(doc, 10, 112, 110, 75, {}, [
        { text: '6. Cechy i numery', font: 'helvetica', fontSize: 5, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        
      ]);
      //small line
      createRectangle(doc, 10, 175, 110, 12, {}, [
        { text: '29. Cechy i numery', font: 'helvetica', fontSize: 5, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 5, align: 'left', bold: false, x: 4, y: 7 },
        
      ]);
      //10
      createRectangle(doc, 120, 112, 25, 75, {}, [
        { text: '6. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ...
      createRectangle(doc, 10, 187, 95, 35, {}, [
        { text: '13. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);

      //14
      createRectangle(doc, 10,222, 95, 27, {}, [
        { text: '14. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);
      //21
      createRectangle(doc, 10,249, 95, 17, {}, [
        { text: '21. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);

      //22
      createRectangle(doc, 10,266, 63.3, 25, {}, [
        { text: '22. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);
      //23
      createRectangle(doc, 73.3 ,266, 63.3, 25, {}, [
        { text: '23. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);
      //24
      createRectangle(doc, 136.6 ,266, 63.3, 25, {}, [
        { text: '24. Cechy i numery', font: 'helvetica', fontSize: 6, align: 'left', bold: true, x: 2, y: 4 },
        { text: 'Marks and Nos', font: 'helvetica', fontSize: 6, align: 'left', bold: false, x: 4, y: 9 },
      ]);
