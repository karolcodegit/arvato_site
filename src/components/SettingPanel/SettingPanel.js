    ...
    <div>
      ...
      >
        ...
        <span className="font-medium text-lg">Size font</span>
          <div className="flex mt-4">
          <button onClick={() => handleFontSizeChange('text-sm')} className="rounded-lg bg-gray-200 px-3 py-1">Smaller</button>
          <button onClick={() => handleFontSizeChange('text-base')} className="rounded-lg bg-gray-200 px-3 py-1 mx-4">Normal</button>
          <button onClick={() => handleFontSizeChange('text-lg')} className="rounded-lg bg-gray-200 px-3 py-1">Bigger</button>
          </div>
        </div>
        <div className="mt-10">
